-- Test Bottle Deposits ONLY (No Notifications)
-- This script adds bottle transactions WITHOUT notifications
-- So we can test if the notification system works automatically

-- Add test transactions for each user (NO notifications)
-- User 1: FF FF f fttt
...
SELECT 
    ...
    COUNT(n.notification_id) as notifications_count
FROM users u

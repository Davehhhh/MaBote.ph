-- Add 1000 points to Stefan for testing redemptions
...
INSERT INTO transactions (
    ...
    @user_id,
    CONCAT('TEST-', @user_id, '-', UNIX_TIMESTAMP()),
...
INSERT INTO notification (
    ...
    'points',
    '🎉 Test Points Added!',
    CONCAT('You received ', @points_to_add, ' test points for redemption testing.'),
    NOW(),
    0,
    'high'
);

...
-- Replace 1000 with the number of points to add

SET @target_email = 'stefanchan32@gmail.com';
SET @points_to_add = 1000;

-- Get user ID (FIXED: Added quotes around email)
SET @user_id = (SELECT user_id FROM users WHERE email = 'stefanchan32@gmail.com' LIMIT 1);
